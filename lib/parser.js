...
const deprecatedArgs = [
  ...
  [['--testcaselogId'], {
    ...
    , defaultValue: null
    , example: "1"
    , help: 'run testcases id'
  }],

  //to be aborted cus full-reset is for this func.
  [['--installapp'], {
    required: false
    , dest: 'installapp'
    , defaultValue: null
  ...
  [['--screenpath'], {
    defaultValue: 'C:/Testwa/Generator/screenshots'
    , dest: 'screenshotPath'
    , required: false
    , example: "E:\\lib"
  ...
  [['--portalHeartbeat'], {
    defaultValue: false
    , dest: 'portalHeartbeat'
    , action: 'storeTrue'
    , required: false
    , example: "true/false"
    , help: "--portalHeartbeat"
    , nargs: 0
  }],
  ...
  [['--reportPath'], {
    defaultValue: 'C:/Testwa/Generator/report'
    , dest: 'reportPath'
    , required: false
    , example: "E:\\lib"
    , help: "report path"
